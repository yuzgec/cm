                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                ...
                                <tr>
                                    ...
                                    <th>Hak Ediş</th>
                                    <th class="text-center">Hak Ediş Sıklığı</th>
                                    <th class="text-center">En az</th>
                                    <th class="text-center">En çok</th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach ($IzinKurallari as $item)
                                    <tr>
                                        ...
                                        <td class="text-muted text-center">
                                            {{ ($item->hakedis_sikligi) ? $item->hakedis_sikligi : '-' }}
                                        </td>
                                        <td class="text-muted text-center">
                                            {{ ($item->izin_enaz) ? $item->izin_enaz : '-' }}
                                        </td>
                                        <td class="text-muted text-center">
                                            {{ ($item->izin_encok) ? $item->izin_encok : '-' }}
                                        </td>
