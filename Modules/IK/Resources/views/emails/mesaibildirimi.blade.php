                ...
                <tr>
                    <td align="center" valign="top">
                        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                            <tr>
                                <td align="center" valign="top" style="background:#232e3c;">
                                    <p style="color: white; font-weight: bolder; font-size: 18px">Mesai Bildirimi</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                            <tr>
                                <td align="left" valign="top" style="background:#FFF;padding:10px">
                                    <p>Merhaba,<br>
                                        {{$user->full_name}} {{\Carbon\Carbon::parse($Tarih)->format('d.m.Y')}} Tarihinde mesaiye gelmemiştir. <br/><br/>Bilgilerinize
                                    </p>
                                </td>
                            </tr>
                        </table>
