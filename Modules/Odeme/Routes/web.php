<?php
    ...
    Route::get('/odeme-basarili', 'OdemeController@success')->name('success')->middleware('auth');
    Route::get('/odeme-basarisiz', 'OdemeController@failed')->name('failed')->middleware('auth');
