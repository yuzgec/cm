                ...
                <div class="page-header d-print-none">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <div class="text-muted mt-1 mb-1">Toplam ({{ $all->count() }}) kullanici bulunmaktadır.</div>
                        </div>
                        ...
                        <div class="col-auto ms-auto d-print-none mb-1">
                            <div class="d-flex">
                                ...
                                <a href="{{ route('kullanici.create')}}" class="btn btn-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <table class="table table-vcenter card-table">
                                ...
                                @foreach ($all as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm btn-square" href="{{ route('kullanici.edit', $item->id) }}">
                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('kullanici.destroy', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
