@extends('master')
@section('title', 'Kullanıcı Oluştur | '.config('app.name'))
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control" name="phone" placeholder="Kullanıcı Telefon Numarası Giriniz...." value="{{ old('phone') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="password" class="form-control" name="password" placeholder="Kullanıcı Şifresi Giriniz...." value="{{ old('password') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col">
                                        <input type="password" class="form-control" name="password_confirmation" placeholder="Kullanıcı Şifresi  Giriniz...." value="{{ old('password_confirmation') }}">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mt-2">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-3 row">
                                    <div class="col">
                                        <select class="form-select" multiple name="roles" size="5">
                                            <option value="1"> Süper Admin</option>
                                            <option value="1"> Admin</option>
                                            <option value="1"> Raporlama</option>
