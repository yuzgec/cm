    ...
    <div class="col-sm-12 col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('roller.update', $Detay->id)}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    @method('PUT')
                    @csrf
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" name="name" placeholder="Rol Adı Giriniz...." value="{{ $Detay->name }}" autocomplete="off">
                                        </div>
                                    </div>
