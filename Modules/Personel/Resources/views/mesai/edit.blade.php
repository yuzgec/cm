                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col">
                                            <select class="form-select" name="mesai_yonetici">
                                                ...
                                                @foreach($Personel as $item)
                                                    <option value="{{$item->remote_id}}" {{ ($item->remote_id == $Mesai->mesai_yonetici) ? 'selected' : null }}>
                                                        {{$item->adsoyad}}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col">
                                            <input type="color" class="form-control" name="mesai_renk" value="{{$Mesai->mesai_renk}}">
                                        </div>
                                    </div>
