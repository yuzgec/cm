@extends('master')
@section('title', 'Personel Mesai Listesi | '.config('app.name'))
@section('content')
                            ...
                            <table class="table table-vcenter card-table">
                                ...
                                @foreach ($Mesai as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm btn-square" href="{{ route('mesai.edit', $item->id) }}">
                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('mesai.destroy', $item->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
