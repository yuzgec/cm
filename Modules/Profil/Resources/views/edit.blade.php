@extends('master')
@section('content')
    {{Form::model($Personel, ["route" => "profil.guncelle"])}}
    @method('PUT')
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" disabled value="{{$Personel->getRoleNames()->first()}}">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" disabled value="{{@$Personel->sube()->first()->name}}">
                                            </div>
                                            <div class="col-6">
                                                <label class="form-label">Departman</label>
                                                <input type="text" class="form-control" disabled value="{{@$Personel->departman()->first()->name}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
